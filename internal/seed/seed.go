...
// Bundle holds the three rendered seed documents.
type Bundle struct {
...
// the operator's intent, so it's an error instead.
func Render(net config.Network, inst config.Instance, opts Options) (Bundle, error) {
